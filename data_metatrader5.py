...
def cerrar_operaciones_por_tiempo(servidor, numero_cuenta, contraseña, velas_permitidas, temporalidad):
    """
    ...
    for op in operaciones:
        ...
        if minutos_transcurridos > tiempo_maximo_minutos:
            ...
            # Cerrar la operación
            resultado_cierre = cerrar_operacion_por_ticket(ticket)
...
def cerrar_operacion_por_ticket(ticket):
    """
